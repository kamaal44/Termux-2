...
echo "\e[032m" "Please Don't copy the Code And Give creadits If you are using this project"
...
echo "\e[032m"
pkg install git -y && echo "\e[032m" && git clone https://github.com/khansaad1275/HangmanPy.git
...
echo ""
echo '\033[1mType ./game.sh to start the Termux-Games\033[0m' | lolcat -a
