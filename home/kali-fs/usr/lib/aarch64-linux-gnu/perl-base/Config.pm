...
tie %Config, 'Config', {
    ...
    exe_ext => '',
    inc_version_list => '5.30.2 5.30.2/aarch64-linux-gnu-thread-multi 5.30.0 5.30.0/aarch64-linux-gnu-thread-multi',
    intsize => '4',
    ...
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/local/lib/aarch64-linux-gnu/perl/5.30.3',
    sitelibexp => '/usr/local/share/perl/5.30.3',
    so => 'so',
    useithreads => 'define',
