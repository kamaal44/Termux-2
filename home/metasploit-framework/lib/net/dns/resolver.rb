...
module Net # :nodoc:
  module DNS
    ...
    class Resolver
      ...
      #
      # Files except for /data/data/com.termux/files/usr/etc/resolv.conf must be owned by the effective userid
      ...
      def initialize(config = {})
        ...
        # 2) ENV variables
        # 3) config file
        # 4) defaults (and /data/data/com.termux/files/usr/etc/resolv.conf for config)
        #------------------------------------------------------------
