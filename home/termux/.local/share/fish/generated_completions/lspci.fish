# lspci
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man8/lspci.8.gz
...
complete -c lspci -s i --description 'Use  <file> as the PCI ID list instead of /data/data/com.'
